...
import {Footer, NewsLetter,  SimpleFeature} from "./partials/dashboard/Elements";
import { startupslottie, capitallottie,futurevideo } from "./assets";
import { MotionContainer } from "./partials/dashboard/Elements";
...
if(path){
  ...
  return(
    ...
    <Hero
      ...
      />   
    <ExperienceDigitalFarming/>
    <CTA title="Start shopping for digital farms now."/>
     <div className="px-4">
     <Highlight/>
    </div>
...
return(
  <>
    {/* // <!-- Hero --> */}
<div class="max-w-[85rem] mx-auto px-4 h-screen  mt-20  sm:px-6  md:mt-8 lg:mt-0 lg:px-8 ">
  {/* <!-- Grid --> */}
  <div class="grid lg:grid-cols-12 lg:gap-x-8 xl:gap-x-12 lg:place-items-center">
    <div class="lg:col-span-6 ">
      <h1 class="block text-6xl font-bold text-gray-800 sm:text-7xl lg:text-5xl  leading-tight lg:tracking-wide bg-transparent bg-clip-text bg-gradient-to-t from-white to-gray-800 text-transparent ">Experience<br className=" hidden sm:block"/> <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-500 sm:text-7xl"> The Future</span></h1>
      <div className="">
      <p class="mt-3 text-lg sm:text-3xl md:text-4xl lg:text-xl text-gray-800 ">Medik 420 brings a whole new meaning to passive income and fund raising.</p>
      </div>

      <div class="mt-5 lg:mt-8 flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
        {/* <div class="w-full sm:w-auto">
          <label for="hero-input" class="sr-only">Search</label>
          <input type="text" id="hero-input" name="hero-input" class="py-3 px-4 block w-full xl:min-w-[18rem] border-gray-200 shadow-sm rounded-md focus:z-10 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 " placeholder="Enter work email"/>
        </div> */}
        <Link to={'/register'} class="w-full sm:w-auto inline-flex justify-center items-center gap-x-3 text-center bg-blue-600 hover:bg-blue-700 border border-transparent text-white font-medium rounded-3xl  transition py-3 px-4 sm:text-3xl lg:text-xl" >
          Get started
        </Link>
      </div>
...
{/* <!-- End Hero --> */}
 ...
 const history = useNavigate()
  ...
  return (
    <>
      <section className={`${bg} relative px-4 font-space  py-12 bg-black `}>
        <div className="relative max-w-7xl mx-auto  ">
          <div className="flex flex-col sm:flex-row items-center justify-between lg:justify-center sm:py-12">
            <div className="w-full md:w-1/2 md:mb-0  sm:px-2">
              <h1
                className={` font-space text-3xl font-bold  text-left sm:text-left uppercase  text-gray-200`}
              >{`Build Wealth`}</h1>
              <p className="text-xl leading-normal mb-8 text-left  ">
                {
                  <>
                    <Typewriter
                      options={{
            ...
            <video
              ...
              src="https://cdn.sanity.io/files/noj3nhym/production/e6d370d50c94bb32d8f28262791f62555bb7e9cc.mp4"
              poster="https://cdn.sanity.io/images/noj3nhym/production/d5f8fb875f672f0200bc64411bbfda8893fb74f7-2051x1596.png"
              autoPlay
              playsInline
              muted
              loop
...
function ExperienceDigitalFarming() {
  return (
    <>
      <div class="py-8 ">
        <div class="container m-auto space-y-8 px-6 text-gray-800 md:px-12 lg:px-20">
          <div class="justify-center gap-6 text-center md:flex md:text-left lg:items-center lg:gap-16">
            <div class="order-last mb-6 space-y-6 md:mb-0 md:w-6/12 lg:w-6/12">
              <h1 class="text-4xl font-bold text-gray-800 md:text-5xl ">
                Grow with{" "}
                <span class="text-gray-800 ">Digital Farming</span>
              </h1>
              <p class="text-lg text-gray-800 ">
                Join hundreds of users around the world earning from sophisticated farms without leaving their home.
              </p>
            ...
            <div class="grid grid-cols-5 grid-rows-4 gap-4 md:w-5/12 lg:w-6/12">
              ...
              <video
              poster={'https://cdn.sanity.io/images/noj3nhym/production/27c08f845fed4231ab7ccf6a315dc92a150fa408-1606x1600.png'}
              autoPlay
              muted
              loop
              playsInline
...
export function Highlight(params) {
  return(
    <>
     ...
     <h3 className={`text-xl font-space ${styles.heading2} text-blk  sm:text-center `}>Built for you </h3>
     <div className="grid grid-cols-1 sm:gap-y-8  ">
    ...
    <>
      <section class="bg-bgSecondary" id="bank_like_an_investor">
       ...
       <h2 class={"text-white wrap title24 font-medium tracking-tight md:display60 md:font-medium md:leading-none pt-[40px]  md:pb-[56px] md:pt-[90px]" +styles.heading2}>
        ...
        <div class="wrap flex flex-col-reverse md:flex-row md:justify-around">
          <div class="md:flex-1 lg:flex-initial px-8 md:pr-32 lg:pr-0">
            <img
              ...
              src="https://cdn.sanity.io/images/noj3nhym/production/786aafefe49e28d2777561074402527cac3efee1-870x964.png"
        ...
        <div class="wrap flex flex-col md:flex-row-reverse md:justify-around pt-8 md:pt-0 lg:pt-24 ">
          ...
          <div class="flex flex-col md:flex-1 lg:max-w-[432px] md:justify-center px-[12px] ">
            <h3 class="text-[20px] md:text-[26px] font-medium tracking-tight leading-6 py-[12px] text-gray-200">
              Say goodbye to hidden fees.
            </h3>
            <p class="body16 leading-tight sm:text-xl text-gray-200">
             Medik Stash
        ...
        <div class="md:hidden pb-10 w-full overflow-hidden ">
          <img
       ...
       <a
              class="label16 font-semibold leading-5 sm:text-2xl  pt-10 pb-20 text-gray-200"
  ...
  <div class="xl:container m-auto px-6 text-gray-600 md:px-12 xl:px-16">
    <div class="lg:bg-gray-200  lg:p-16 rounded-[4rem] space-y-6 sm:flex sm:gap-6 justify-center sm:space-y-0 lg:items-center">
      <div class="sm:w-5/12 lg:w-1/2">
        {/* <img
          src="https://cdn.sanity.io/images/noj3nhym/production/666dcf24e3889dcdf1d4ff2f44ac98829a5585d8-495x418.svg"
          alt="image"
          loading="lazy"
          width=""
          height=""
...
<LottiePlayer src={capitallottie} width="full"  />
      </div>
      <div class="sm:w-7/12 lg:w-1/2">
        <h2 class="text-3xl font-bold text-gray-900 sm:text-4xl ">
           Explore Pipe Funding
        </h2>
        <p class="my-8 text-gray-600 ">
        Tap into stable, funding and investment opportunities with Pipe by trading future revenue.
        </p>
